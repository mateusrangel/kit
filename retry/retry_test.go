...
func TestExecute(t *testing.T) {
	...
	functionThatWorksOnTheThirdTry := func() func() (any, error) {
		var callCount int
	...
	functionThatAlwaysWorks := func() (any, error) { return true, nil }
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, gotErr := retry.Execute(tt.ctx, tt.fn, tt.retries, tt.backoff)
			if gotErr != nil {
				if !tt.wantErr {
